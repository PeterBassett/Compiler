...
require(["jasmine-boot"], () => 
{
  require(["./Memory/RAM.tests", 
            ...
            "./Compiler/CodeGenerator/WasmCodeGenerator/stringEncoding.tests",
            "./Compiler/CodeGenerator/WasmCodeGenerator/ieeeEncoding.tests",
            "./Compiler/CompileAndExecute/WASM/CompileAndExecuteWasm.tests",
