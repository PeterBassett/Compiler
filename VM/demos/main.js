...
require(["./pixels"], function(pixels){
  var pixels = new pixels.default();
...
loop:        
  ...
  function frame()
  {
    var executed = pixels.step();
    
    pixels.display("registers", "memory");

    if(executed)
    {
      document.getElementById("footer").innerText = "Executing";
    }
    else
    {
        var end = new Date();
        ...
        document.getElementById("footer").innerText = "Complete : " + elapsed / 1000;    
    }
